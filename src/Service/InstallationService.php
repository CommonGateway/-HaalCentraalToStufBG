...
class InstallationService implements InstallerInterface
{
    ...
    {
        $this->logger->debug("HaalCentraalToStufBGBundle -> Install()");
    ...
    {
        $this->logger->debug("HaalCentraalToStufBGBundle -> Update()");
    ...
    {
        $this->logger->debug("HaalCentraalToStufBGBundle -> Uninstall()");
